...
import { Eye, CheckCircle, FileText, Loader2, Grid, List, Filter , AlertTriangle } from "lucide-react";
...
export default function ApprovedApplications() {
  ...
  const { exportCSV, exportPDF, printData, exporting } = useExport({
    ...
    pdfTitle: 'Approved Applications Report',
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-lg font-bold">Approved Applications</h1>
