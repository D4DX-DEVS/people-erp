        ...
        {canViewApplications && (
          <Card className="hover:shadow-glow transition-all duration-300">
            ...
            <CardContent>
              <div className="space-y-4">
                {recentApplications.map((app) => (
                  <div
                    ...
                    onClick={() => navigate(app._id ? `/applications/all?application=${app._id}` : '/applications/all')}
                  >
              ...
              <Button variant="outline" className="w-full mt-4 rounded-full" onClick={() => navigate('/applications/all')}>
