  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: "Gallery",
        permissions: ["website.read"],
        keywords: ["gallery", "photos", "album", "images"],
      },
      {
        to: "/website-videos",
        icon: Video,
      ...
      },
      {
        ...
        label: "Blogs",
        permissions: ["website.read"],
        keywords: ["blog", "article", "post", "story"],
      },
      {
        to: "/website-media",
        icon: Newspaper,
        ...
        permissions: ["website.read"],
        keywords: ["media", "press", "coverage", "news"],
      },
      {
        to: "/website-faqs",
        icon: HelpCircle,
      ...
      },
      {
        ...
        permissions: ["website.read"],
        keywords: ["contact", "messages", "inbox", "enquiry"],
      },
      {
        to: "/website-volunteers",
        icon: HeartHandshake,
        label: "Volunteers",
        permissions: ["website.read"],
        keywords: ["volunteer", "signup", "join"],
      },
    ],
  },
  {
